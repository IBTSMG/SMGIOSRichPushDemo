...
class UserNotificationController: NSObject, UNUserNotificationCenterDelegate {
    ...
    private var followCategory: UNNotificationCategory = {
        return UNNotificationCategory(identifier: "follow", actions: [InteractiveNotifications.Read.action(), InteractiveNotifications.Follow.action()], intentIdentifiers: [], options: [])
    }()
    
    private var saveCategory: UNNotificationCategory = {
        return UNNotificationCategory(identifier: "save", actions: [InteractiveNotifications.Read.action(), InteractiveNotifications.Save.action()], intentIdentifiers: [], options: [])
    }()
    
    private var interactiveCategory: UNNotificationCategory = {
        return UNNotificationCategory(identifier: "interactive", actions: [InteractiveNotifications.Read.action(), InteractiveNotifications.Follow.action()], intentIdentifiers: [], options: [])
    }()
